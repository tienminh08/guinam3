            ...
            <div class="max-w-6xl mx-auto">
                ...
                <div class="flex items-center lg:justify-between justify-around">
                    ...
                    <div class="capitalize flex font-semibold hidden lg:block my-2 space-x-3 text-center text-sm">
                        ...
                        <a href="/bootstrap/feed/demo.foxthemes.net/instellohtml/Form-ShowOneAccount.jsp" class="bg-pink-500 pink-500 px-6 py-3 rounded-md shadow text-white">Register</a>
                    </div>
            ...
            <div class="lg:p-12 max-w-md max-w-xl lg:my-0 my-12 mx-auto p-6 space-y-">
                ...
                <form action="#">
                    ...
                    <div class="text-center mt-5 space-x-2">
                        <p class="text-base"> Not registered? <a href="/bootstrap/feed/demo.foxthemes.net/instellohtml/Form-ShowOneAccount.jsp" class=""> Create a account </a></p>
                    </div>
                </form>
            </div>
        </div>
