    ...
    <header>
      <div class="header_inner">
        ...
        <div class="right-side lg:pr-4">
          ...
          <a type="button" href="/Show">Back</a>
          <!-- upload -->
          <a href="#"
            ...
            <ion-icon name="add-circle" class="-mb-1
                             mr-1 opacity-90 text-xl uilus-circle">Back</ion-icon>
            Back
          </a>
          <!-- upload dropdown box -->
      ...
      <div class="relative mt-4" uk-slider="finite: true">
        ...
        <div class="uk-slider-container pb-3">
          ...
          <ul class="uk-slider-items uk-child-width-1-5@m uk-child-width-1-3@s uk-child-width-1-2 uk-grid-small uk-grid">
            ...
            <%--                        <c:forEach var="p" items="${lispostbyusername}">--%>
            <%--                        <li>--%>
            <%--                                &lt;%&ndash;                                    <a href="" uk-toggle="target: #offcanvas-preview">&ndash;%&gt;--%>
            <%--                            <div class="market-list">--%>
            <%--                                &emsp;--%>
            <%--                                <div class="item-media" >--%>
            <%--                                    <a type="button" href="/deletepost?id=${p.getIdaccounts()}"> <img--%>
            <%--                                            src="${p.getImg()}"--%>
            <%--                                            alt=""> </a>--%>
            <%--                                </div>--%>
            ...
            <%--                                        <div class="item-price"><a>${p.getContent()}</a>--%>
            <%--                                            &emsp; </div>--%>
            <%--                                    </div>--%>
            <%--                                    <div class="item-title">--%>
            <%--                                        <div class="item-price"><a>${p.getLikecount()}</a>--%>
            <%--                                            &emsp; </div>--%>
            <%--                                    </div>--%>
            <%--                                    <div class="item-title">--%>
            <%--                                        <div class="item-price"><a>${p.getTime()}</a>--%>
            <%--                                            &emsp; </div>--%>
            <%--                                    </div>--%>
            <%--                                    <div class="item-statistic">--%>

            <%--                                        <img src="">--%>
            <%--                                            &lt;%&ndash;                                        <a type="button" href="">Lock up</a> &emsp;&ndash;%&gt;--%>
            <%--                                            &lt;%&ndash;                                        <a type="button" href="/Delete?id=${p.getIdAccounts()}">Delete</a>&ndash;%&gt;--%>
            ...
            <li>
              ...
              <div class="market-list">
                &emsp;
                <div class="item-media" >
                  <a type="button" href="/delete?idaccounts=${p.idPost}">
                    <img
                          src="${p.img}"
                          > </a>
                </div>
                ...
                <div class="item-inner">
                  ...
                  <div class="item-title">
                    <div class="item-price"><a>${p.content}</a>
                      &emsp; </div>
                  </div>
                  <div class="item-statistic">
                      ...
                      <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <a type="button" href="/delete?idposts=${p.getIdPost()}">Confirm</a>
...
<%--                          </div>--%>
                      ...
                      <%--                       <a type="button" href="/confirmdelete?idposts=${p.getIdPost()}">Delete</a>--%>
            ...
            <%--        <a href="#" uk-toggle="target: #offcanvas-preview">--%>
            <%--            <div class="market-list">--%>
            <%--                <div class="item-media"> <img src="${p.getImg}" alt=""></div>--%>
            ...
            <div class="relative" uk-slider="finite: true">
              ...
              <div class="uk-slider-container pb-3">
                ...
                <ul
                  ...
                  <%--                                                </li>--%>
                  <%--                        <c:forEach var="p" items="${listaccounts}">--%>
                  <%--                            <li>--%>
                  <%--                                    &lt;%&ndash;                                    <a href="" uk-toggle="target: #offcanvas-preview">&ndash;%&gt;--%>
                  <%--                                <div class="market-list">--%>
                  <%--                                    &emsp;--%>
                  <%--                                    <div class="item-media" >--%>
                  <%--                                        <a type="button" href="/ShowOne?id=${p.getUsername()}"> <img--%>
                  <%--                                                src="${p.getAvatarurl()}"--%>
                  <%--                                                alt=""> </a>--%>
                  <%--                                    </div>--%>
